...
describe("PricingIntentsClient", () => {
    test("list (1)", async () => {
        ...
        const rawResponseBody = {
            ...
            hasMore: true,
            links: [
                { rel: "previous", method: "get", href: "https://api.payroc.com/v1/pricing-intents?before=5&limit=1" },
                { rel: "next", method: "get", href: "https://api.payroc.com/v1/pricing-intents?after=5&limit=1" },
            ],
            data: [
                {
                    country: "US",
        ...
        const page = await client.boarding.pricingIntents.list({
            before: "2571",
            after: "8516",
            limit: 1,
        });
            ...
            data: [
                {
                    ...
                    gateway: { fees: { monthly: 1, setup: 1, perTransaction: 1, perDeviceMonthly: 1 } },
                    services: [{ name: "hardwareAdvantagePlan", enabled: true }],
                    id: "id",
                    createdDate: "2024-07-02T09:00:00Z",
                    lastUpdatedDate: "2024-07-02T09:00:00Z",
    ...
    test("list (3)", async () => {
        ...
        await expect(async () => {
            return await client.boarding.pricingIntents.list();
