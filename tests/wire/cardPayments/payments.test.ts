...
describe("PaymentsClient", () => {
    ...
    test("create (4)", async () => {
        ...
        await expect(async () => {
            return await client.cardPayments.payments.create({
    ...
    test("retrieve (1)", async () => {
        ...
        const response = await client.cardPayments.payments.retrieve({
            paymentId: "M2MJOG6O2Y",
        });
        expect(response).toEqual({
            paymentId: "M2MJOG6O2Y",
    ...
    test("retrieve (2)", async () => {
        ...
        await expect(async () => {
            return await client.cardPayments.payments.retrieve({
                paymentId: "paymentId",
            });
        }).rejects.toThrow(Payroc.BadRequestError);
    });
    ...
    test("adjust (1)", async () => {
        ...
        const response = await client.cardPayments.payments.adjust({
            "Idempotency-Key": "8e03978e-40d5-43e8-bc93-6894a57f9324",
            paymentId: "M2MJOG6O2Y",
            adjustments: [
                {
    ...
    test("adjust (2)", async () => {
        ...
        await expect(async () => {
            return await client.cardPayments.payments.adjust({
                "Idempotency-Key": "idempotencyKey",
                paymentId: "paymentId",
                adjustments: [
                    {
    ...
    test("capture (1)", async () => {
        ...
        const response = await client.cardPayments.payments.capture({
            "Idempotency-Key": "8e03978e-40d5-43e8-bc93-6894a57f9324",
            paymentId: "M2MJOG6O2Y",
            processingTerminalId: "1234001",
            operator: "Jane",
    ...
    test("capture (2)", async () => {
        ...
        await expect(async () => {
            return await client.cardPayments.payments.capture({
                "Idempotency-Key": "idempotencyKey",
                paymentId: "paymentId",
            });
        }).rejects.toThrow(Payroc.BadRequestError);
