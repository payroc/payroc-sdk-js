...
describe("EventSubscriptionsClient", () => {
    test("list (1)", async () => {
        ...
        const rawResponseBody = {
            ...
            hasMore: false,
            links: [
                { rel: "next", method: "get", href: "https://api.payroc.com/v1/event-subscriptions?after=10&limit=10" },
            ],
            data: [
                {
                    id: 2565435189324,
                ...
                },
                {
                    ...
                    enabled: true,
                    status: "registered",
                    eventTypes: ["processingAccount.riskStatus.changed"],
                    notifications: [
                        {
                            type: "webhook",
                            uri: "https://my-server/notification/endpoint",
        ...
        const page = await client.notifications.eventSubscriptions.list({
            status: "registered",
    ...
    test("list (2)", async () => {
        ...
        await expect(async () => {
            return await client.notifications.eventSubscriptions.list();
