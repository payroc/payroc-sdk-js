...
describe("SubscriptionsClient", () => {
    test("list (1)", async () => {
        ...
        const rawResponseBody = {
            ...
            data: [
                ...
                },
                {
                    ...
                    recurringOrder: { amount: 3999, description: "Monthly Premium Club subscription" },
                    currentState: {
                        status: "active",
        ...
        server
            ...
            .get("/processing-terminals/1234001/subscriptions")
            .respondWith()
            .statusCode(200)
        ...
        const page = await client.payments.subscriptions.list({
            processingTerminalId: "1234001",
            ...
            data: [
                {
                    ...
                    name: "Premium Club",
                    description:
                        "Monthly Premium Club subscription. Two large pizzas free per month, and exclusive member discounts.",
                    currency: "AED",
                    setupOrder: {
                        orderId: "OrderRef6543",
                        amount: 4999,
    ...
    test("list (3)", async () => {
        ...
        await expect(async () => {
            return await client.payments.subscriptions.list({
    ...
    test("create (1)", async () => {
        ...
        const response = await client.payments.subscriptions.create({
    ...
    test("create (3)", async () => {
        ...
        await expect(async () => {
            return await client.payments.subscriptions.create({
    ...
    test("retrieve (1)", async () => {
        ...
        const response = await client.payments.subscriptions.retrieve({
            processingTerminalId: "1234001",
            subscriptionId: "SubRef7654",
        });
        expect(response).toEqual({
    ...
    test("retrieve (3)", async () => {
        ...
        await expect(async () => {
            return await client.payments.subscriptions.retrieve({
                processingTerminalId: "processingTerminalId",
    ...
    test("partiallyUpdate (1)", async () => {
        ...
        const response = await client.payments.subscriptions.partiallyUpdate({
            "Idempotency-Key": "8e03978e-40d5-43e8-bc93-6894a57f9324",
            processingTerminalId: "1234001",
            subscriptionId: "SubRef7654",
            body: [
    ...
    test("partiallyUpdate (5)", async () => {
        ...
        await expect(async () => {
            return await client.payments.subscriptions.partiallyUpdate({
                "Idempotency-Key": "idempotencyKey",
                processingTerminalId: "processingTerminalId",
                subscriptionId: "subscriptionId",
                body: [
    ...
    test("deactivate (1)", async () => {
        ...
        const response = await client.payments.subscriptions.deactivate({
            processingTerminalId: "1234001",
            subscriptionId: "SubRef7654",
        });
        expect(response).toEqual({
    ...
    test("deactivate (2)", async () => {
        ...
        await expect(async () => {
            return await client.payments.subscriptions.deactivate({
                processingTerminalId: "processingTerminalId",
                subscriptionId: "subscriptionId",
            });
        }).rejects.toThrow(Payroc.BadRequestError);
    ...
    test("reactivate (1)", async () => {
        ...
        const response = await client.payments.subscriptions.reactivate({
            processingTerminalId: "1234001",
            subscriptionId: "SubRef7654",
        });
        expect(response).toEqual({
    ...
    test("reactivate (3)", async () => {
        ...
        await expect(async () => {
            return await client.payments.subscriptions.reactivate({
                processingTerminalId: "processingTerminalId",
                subscriptionId: "subscriptionId",
            });
        }).rejects.toThrow(Payroc.BadRequestError);
    ...
    test("pay (1)", async () => {
        ...
        const response = await client.payments.subscriptions.pay({
            "Idempotency-Key": "8e03978e-40d5-43e8-bc93-6894a57f9324",
            processingTerminalId: "1234001",
            subscriptionId: "SubRef7654",
            operator: "Jane",
    ...
    test("pay (2)", async () => {
        ...
        await expect(async () => {
            return await client.payments.subscriptions.pay({
                "Idempotency-Key": "idempotencyKey",
                processingTerminalId: "processingTerminalId",
                subscriptionId: "subscriptionId",
                order: {},
