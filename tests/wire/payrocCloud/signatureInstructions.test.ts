...
describe("SignatureInstructionsClient", () => {
    test("submit (1)", async () => {
        ...
        const rawRequestBody = { processingTerminalId: "1234001" };
        ...
        const response = await client.payrocCloud.signatureInstructions.submit({
    ...
    test("submit (2)", async () => {
        ...
        await expect(async () => {
            return await client.payrocCloud.signatureInstructions.submit({
    ...
    test("retrieve (2)", async () => {
        ...
        await expect(async () => {
            return await client.payrocCloud.signatureInstructions.retrieve({
                signatureInstructionId: "signatureInstructionId",
            });
        }).rejects.toThrow(Payroc.BadRequestError);
    });
    ...
    test("delete (1)", async () => {
        ...
        server
            .mockEndpoint()
            .delete("/signature-instructions/a37439165d134678a9100ebba3b29597")
            .respondWith()
            .statusCode(200)
            .build();

        const response = await client.payrocCloud.signatureInstructions.delete({
            signatureInstructionId: "a37439165d134678a9100ebba3b29597",
        });
    ...
    test("delete (2)", async () => {
        ...
        await expect(async () => {
            return await client.payrocCloud.signatureInstructions.delete({
                signatureInstructionId: "signatureInstructionId",
            });
        }).rejects.toThrow(Payroc.BadRequestError);
    });
