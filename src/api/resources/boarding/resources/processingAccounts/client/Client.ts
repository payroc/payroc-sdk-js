...
export class ProcessingAccountsClient {
    ...
    public async listOwners(
        ...
        core.PayrocPager<Payroc.Owner, Payroc.boarding.ListProcessingAccountOwnersRequest, Payroc.PaginatedOwners>
    > {
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                request: Payroc.boarding.ListProcessingAccountOwnersRequest,
            ): Promise<core.WithRawResponse<Payroc.PaginatedOwners>> => {
                const { processingAccountId, before, after, limit } = request;
                const _queryParams: Record<string, string | string[] | object | object[] | null> = {};
                if (before != null) {
                    _queryParams.before = before;
                ...
                if (_response.ok) {
                    return { data: _response.body as Payroc.PaginatedOwners, rawResponse: _response.rawResponse };
                }
                if (_response.error.reason === "status-code") {
                    switch (_response.error.statusCode) {
                        case 400:
        ...
        return core.PayrocPager.create<
            Payroc.Owner,
            Payroc.boarding.ListProcessingAccountOwnersRequest,
            Payroc.PaginatedOwners
        >({
            sendRequest: list,
            initialRequest: request,
            parse: async (
                _request: Payroc.boarding.ListProcessingAccountOwnersRequest,
                response: core.WithRawResponse<Payroc.PaginatedOwners>,
            ) => ({
                hasNextPage: false,
    ...
    public async listProcessingTerminals(
        ...
        core.PayrocPager<
            Payroc.ProcessingTerminal,
            Payroc.boarding.ListProcessingTerminalsProcessingAccountsRequest,
    ...
    > {
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                request: Payroc.boarding.ListProcessingTerminalsProcessingAccountsRequest,
            ): Promise<core.WithRawResponse<Payroc.PaginatedProcessingTerminals>> => {
                const { processingAccountId, before, after, limit } = request;
                const _queryParams: Record<string, string | string[] | object | object[] | null> = {};
                if (before != null) {
                    _queryParams.before = before;
                ...
                if (_response.ok) {
                    return {
                        data: _response.body as Payroc.PaginatedProcessingTerminals,
                        rawResponse: _response.rawResponse,
                    };
                }
                if (_response.error.reason === "status-code") {
        ...
        >({
            ...
            initialRequest: request,
            parse: async (
                _request: Payroc.boarding.ListProcessingTerminalsProcessingAccountsRequest,
                response: core.WithRawResponse<Payroc.PaginatedProcessingTerminals>,
            ) => ({
                hasNextPage: false,
                hasPreviousPage: false,
                items: ((response) => response?.data ?? [])(response.data),
