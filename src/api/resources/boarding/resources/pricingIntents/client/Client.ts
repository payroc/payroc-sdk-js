...
export class PricingIntentsClient {
    ...
    public async list(
        ...
        const _sendRequest = async (request: core.Fetcher.Args) => {
            const _response = await core.fetcher<Payroc.PaginatedPricingIntent>(request);
            if (_response.ok) {
                return _response;
            }
        ...
        return core.createPayrocPager<Payroc.PricingIntent, Payroc.PaginatedPricingIntent>({
