...
export class MerchantPlatformsClient {
    ...
    public async list(
        ...
        const _sendRequest = async (request: core.Fetcher.Args) => {
            const _response = await core.fetcher<Payroc.PaginatedMerchants>(request);
            if (_response.ok) {
                return _response;
            }
        ...
        return core.createPayrocPager<Payroc.MerchantPlatform, Payroc.PaginatedMerchants>({
    ...
    public async listProcessingAccounts(
        ...
        const _sendRequest = async (request: core.Fetcher.Args) => {
            const _response = await core.fetcher<Payroc.PaginatedProcessingAccounts>(request);
            if (_response.ok) {
                return _response;
            }
            if (_response.error.reason === "status-code") {
        ...
        return core.createPayrocPager<Payroc.ProcessingAccount, Payroc.PaginatedProcessingAccounts>({
            sendRequest: _sendRequest,
            initialHttpRequest: _request,
            clientOptions: this._options,
            requestOptions: requestOptions,
