...
export interface ListRefundsRequest {
    ...
    type?:
        | Payroc.bankTransferPayments.ListRefundsRequestTypeItem
        | Payroc.bankTransferPayments.ListRefundsRequestTypeItem[];
    /** Filter results by the status of the refund. */
    status?:
        | Payroc.bankTransferPayments.ListRefundsRequestStatusItem
        | Payroc.bankTransferPayments.ListRefundsRequestStatusItem[];
    ...
    settlementState?: Payroc.bankTransferPayments.ListRefundsRequestSettlementState;
