...
export interface ListPaymentsRequest {
    ...
    type?:
        | Payroc.bankTransferPayments.ListPaymentsRequestTypeItem
        | Payroc.bankTransferPayments.ListPaymentsRequestTypeItem[];
    /** Filter results by the status of the payment. */
    status?:
        | Payroc.bankTransferPayments.ListPaymentsRequestStatusItem
        | Payroc.bankTransferPayments.ListPaymentsRequestStatusItem[];
    ...
    settlementState?: Payroc.bankTransferPayments.ListPaymentsRequestSettlementState;
