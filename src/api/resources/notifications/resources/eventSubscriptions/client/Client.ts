...
export class EventSubscriptionsClient {
    ...
    public async list(
        ...
        const _sendRequest = async (request: core.Fetcher.Args) => {
            const _response = await core.fetcher<Payroc.PaginatedEventSubscriptions>(request);
            if (_response.ok) {
                return _response;
            }
        ...
        return core.createPayrocPager<Payroc.EventSubscription, Payroc.PaginatedEventSubscriptions>({
