...
export class FundingRecipientsClient {
    ...
    public async list(
        ...
        const _sendRequest = async (request: core.Fetcher.Args) => {
            const _response = await core.fetcher<Payroc.PaginatedFundRecipients>(request);
            if (_response.ok) {
                return _response;
            }
        ...
        return core.createPayrocPager<Payroc.FundingRecipient, Payroc.PaginatedFundRecipients>({
