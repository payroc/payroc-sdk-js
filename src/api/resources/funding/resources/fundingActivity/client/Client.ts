...
export class FundingActivityClient {
    ...
    public async list(
        ...
        core.PayrocPager<
            Payroc.ActivityRecord,
            Payroc.funding.ListFundingActivityRequest,
            Payroc.funding.ListFundingActivityResponse
        >
    > {
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                request: Payroc.funding.ListFundingActivityRequest,
            ): Promise<core.WithRawResponse<Payroc.funding.ListFundingActivityResponse>> => {
                ...
                if (_response.ok) {
                    return {
                        data: _response.body as Payroc.funding.ListFundingActivityResponse,
                        rawResponse: _response.rawResponse,
                    };
                }
                if (_response.error.reason === "status-code") {
        ...
        >({
            ...
            parse: async (
                _request: Payroc.funding.ListFundingActivityRequest,
                response: core.WithRawResponse<Payroc.funding.ListFundingActivityResponse>,
            ) => ({
                hasNextPage: false,
