...
export class SettlementClient {
    ...
    public async listBatches(
        ...
        core.PayrocPager<
            Payroc.Batch,
            Payroc.reporting.ListReportingSettlementBatchesRequest,
            Payroc.reporting.ListBatchesSettlementResponse
        >
    > {
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                request: Payroc.reporting.ListReportingSettlementBatchesRequest,
            ): Promise<core.WithRawResponse<Payroc.reporting.ListBatchesSettlementResponse>> => {
                ...
                if (_response.ok) {
                    return {
                        data: _response.body as Payroc.reporting.ListBatchesSettlementResponse,
        ...
        >({
            ...
            parse: async (
                _request: Payroc.reporting.ListReportingSettlementBatchesRequest,
                response: core.WithRawResponse<Payroc.reporting.ListBatchesSettlementResponse>,
            ) => ({
                hasNextPage: false,
    ...
    public async listTransactions(
        ...
        core.PayrocPager<
            Payroc.Transaction,
            Payroc.reporting.ListReportingSettlementTransactionsRequest,
            Payroc.reporting.ListTransactionsSettlementResponse
        >
    > {
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                request: Payroc.reporting.ListReportingSettlementTransactionsRequest,
            ): Promise<core.WithRawResponse<Payroc.reporting.ListTransactionsSettlementResponse>> => {
                ...
                if (_response.ok) {
                    return {
                        data: _response.body as Payroc.reporting.ListTransactionsSettlementResponse,
                        rawResponse: _response.rawResponse,
                    };
                }
                if (_response.error.reason === "status-code") {
        ...
        >({
            ...
            initialRequest: request,
            parse: async (
                _request: Payroc.reporting.ListReportingSettlementTransactionsRequest,
                response: core.WithRawResponse<Payroc.reporting.ListTransactionsSettlementResponse>,
            ) => ({
                hasNextPage: false,
                hasPreviousPage: false,
                items: ((response) => response?.data ?? [])(response.data),
    ...
    public async listAuthorizations(
        ...
        core.PayrocPager<
            Payroc.Authorization,
            Payroc.reporting.ListReportingSettlementAuthorizationsRequest,
            Payroc.reporting.ListAuthorizationsSettlementResponse
        >
    > {
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                request: Payroc.reporting.ListReportingSettlementAuthorizationsRequest,
            ): Promise<core.WithRawResponse<Payroc.reporting.ListAuthorizationsSettlementResponse>> => {
                ...
                if (_response.ok) {
                    return {
                        data: _response.body as Payroc.reporting.ListAuthorizationsSettlementResponse,
                        rawResponse: _response.rawResponse,
                    };
                }
                if (_response.error.reason === "status-code") {
        ...
        >({
            ...
            initialRequest: request,
            parse: async (
                _request: Payroc.reporting.ListReportingSettlementAuthorizationsRequest,
                response: core.WithRawResponse<Payroc.reporting.ListAuthorizationsSettlementResponse>,
            ) => ({
                hasNextPage: false,
                hasPreviousPage: false,
                items: ((response) => response?.data ?? [])(response.data),
    ...
    public async listDisputes(
        ...
        core.PayrocPager<
            Payroc.Dispute,
            Payroc.reporting.ListReportingSettlementDisputesRequest,
            Payroc.reporting.ListDisputesSettlementResponse
        >
    > {
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                request: Payroc.reporting.ListReportingSettlementDisputesRequest,
            ): Promise<core.WithRawResponse<Payroc.reporting.ListDisputesSettlementResponse>> => {
                const { before, after, limit, date, merchantId } = request;
                const _queryParams: Record<string, string | string[] | object | object[] | null> = {};
                if (before != null) {
                    _queryParams.before = before;
                ...
                if (_response.ok) {
                    return {
                        data: _response.body as Payroc.reporting.ListDisputesSettlementResponse,
                        rawResponse: _response.rawResponse,
                    };
                }
                if (_response.error.reason === "status-code") {
        ...
        >({
            ...
            initialRequest: request,
            parse: async (
                _request: Payroc.reporting.ListReportingSettlementDisputesRequest,
                response: core.WithRawResponse<Payroc.reporting.ListDisputesSettlementResponse>,
            ) => ({
                hasNextPage: false,
                hasPreviousPage: false,
                items: ((response) => response?.data ?? [])(response.data),
    ...
    public async listAchDeposits(
        ...
        core.PayrocPager<
            Payroc.AchDeposit,
            Payroc.reporting.ListReportingSettlementAchDepositsRequest,
            Payroc.reporting.ListAchDepositsSettlementResponse
        >
    > {
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                request: Payroc.reporting.ListReportingSettlementAchDepositsRequest,
            ): Promise<core.WithRawResponse<Payroc.reporting.ListAchDepositsSettlementResponse>> => {
                const { before, after, limit, date, merchantId } = request;
                const _queryParams: Record<string, string | string[] | object | object[] | null> = {};
                if (before != null) {
                    _queryParams.before = before;
                ...
                if (_response.ok) {
                    return {
                        data: _response.body as Payroc.reporting.ListAchDepositsSettlementResponse,
                        rawResponse: _response.rawResponse,
                    };
                }
                if (_response.error.reason === "status-code") {
        ...
        >({
            ...
            initialRequest: request,
            parse: async (
                _request: Payroc.reporting.ListReportingSettlementAchDepositsRequest,
                response: core.WithRawResponse<Payroc.reporting.ListAchDepositsSettlementResponse>,
            ) => ({
                hasNextPage: false,
                hasPreviousPage: false,
                items: ((response) => response?.data ?? [])(response.data),
    ...
    public async listAchDepositFees(
        ...
        core.PayrocPager<
            Payroc.AchDepositFee,
            Payroc.reporting.ListReportingSettlementAchDepositFeesRequest,
            Payroc.reporting.ListAchDepositFeesSettlementResponse
        >
    > {
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                request: Payroc.reporting.ListReportingSettlementAchDepositFeesRequest,
            ): Promise<core.WithRawResponse<Payroc.reporting.ListAchDepositFeesSettlementResponse>> => {
                ...
                if (_response.ok) {
                    return {
                        data: _response.body as Payroc.reporting.ListAchDepositFeesSettlementResponse,
                        rawResponse: _response.rawResponse,
                    };
                }
                if (_response.error.reason === "status-code") {
        ...
        >({
            ...
            initialRequest: request,
            parse: async (
                _request: Payroc.reporting.ListReportingSettlementAchDepositFeesRequest,
                response: core.WithRawResponse<Payroc.reporting.ListAchDepositFeesSettlementResponse>,
            ) => ({
                hasNextPage: false,
                hasPreviousPage: false,
                items: ((response) => response?.data ?? [])(response.data),
