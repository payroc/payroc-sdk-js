...
export interface ListRefundsRequest {
    ...
    tender?: Payroc.cardPayments.ListRefundsRequestTender;
    /** Filter refunds by the current status of the refund. */
    status?: Payroc.cardPayments.ListRefundsRequestStatusItem | Payroc.cardPayments.ListRefundsRequestStatusItem[];
    ...
    settlementState?: Payroc.cardPayments.ListRefundsRequestSettlementState;
