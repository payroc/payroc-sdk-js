...
export class SignaturesClient {
     ...
     *
     * @param {Payroc.payments.RetrieveSignaturesRequest} request
    ...
    ): core.HttpResponsePromise<Payroc.payments.RetrieveSignaturesResponse> {
    ...
    private async __retrieve(
        request: Payroc.payments.RetrieveSignaturesRequest,
        requestOptions?: SignaturesClient.RequestOptions,
    ): Promise<core.WithRawResponse<Payroc.payments.RetrieveSignaturesResponse>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as Payroc.payments.RetrieveSignaturesResponse,
