...
export class PaymentLinksClient {
     ...
     *
     * @param {Payroc.payments.ListPaymentLinksRequest} request
     ...
     *
     * @example
     *     await client.payments.paymentLinks.list({
    ...
    public async list(
        ...
        core.PayrocPager<
            Payroc.PaymentLinkPaginatedListDataItem,
            Payroc.payments.ListPaymentLinksRequest,
            Payroc.PaymentLinkPaginatedList
        >
    > {
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                request: Payroc.payments.ListPaymentLinksRequest,
            ): Promise<core.WithRawResponse<Payroc.PaymentLinkPaginatedList>> => {
                const {
                ...
                if (_response.ok) {
                    return {
                        data: _response.body as Payroc.PaymentLinkPaginatedList,
        ...
        >({
            ...
            parse: async (
                _request: Payroc.payments.ListPaymentLinksRequest,
                response: core.WithRawResponse<Payroc.PaymentLinkPaginatedList>,
            ) => ({
                hasNextPage: false,
     ...
     *
     * @param {Payroc.payments.CreatePaymentLinksRequest} request
     * @param {PaymentLinksClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Payroc.BadRequestError}
     * @throws {@link Payroc.UnauthorizedError}
    ...
    public create(
        ...
        requestOptions?: PaymentLinksClient.RequestOptions,
    ): core.HttpResponsePromise<Payroc.payments.CreatePaymentLinksResponse> {
    ...
    private async __create(
        request: Payroc.payments.CreatePaymentLinksRequest,
        requestOptions?: PaymentLinksClient.RequestOptions,
    ): Promise<core.WithRawResponse<Payroc.payments.CreatePaymentLinksResponse>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as Payroc.payments.CreatePaymentLinksResponse,
                rawResponse: _response.rawResponse,
            };
        }
     ...
     * - **status** - Indicates if the payment link is active.
     *
     * @param {Payroc.payments.RetrievePaymentLinksRequest} request
     * @param {PaymentLinksClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Payroc.BadRequestError}
     * @throws {@link Payroc.UnauthorizedError}
    ...
    public retrieve(
        ...
        requestOptions?: PaymentLinksClient.RequestOptions,
    ): core.HttpResponsePromise<Payroc.payments.RetrievePaymentLinksResponse> {
    ...
    private async __retrieve(
        request: Payroc.payments.RetrievePaymentLinksRequest,
        requestOptions?: PaymentLinksClient.RequestOptions,
    ): Promise<core.WithRawResponse<Payroc.payments.RetrievePaymentLinksResponse>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as Payroc.payments.RetrievePaymentLinksResponse,
                rawResponse: _response.rawResponse,
            };
        }
     ...
     *
     * @param {Payroc.payments.PartiallyUpdatePaymentLinksRequest} request
     * @param {PaymentLinksClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Payroc.BadRequestError}
     * @throws {@link Payroc.UnauthorizedError}
    ...
    public partiallyUpdate(
        ...
        requestOptions?: PaymentLinksClient.RequestOptions,
    ): core.HttpResponsePromise<Payroc.payments.PartiallyUpdatePaymentLinksResponse> {
    ...
    private async __partiallyUpdate(
        request: Payroc.payments.PartiallyUpdatePaymentLinksRequest,
        requestOptions?: PaymentLinksClient.RequestOptions,
    ): Promise<core.WithRawResponse<Payroc.payments.PartiallyUpdatePaymentLinksResponse>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as Payroc.payments.PartiallyUpdatePaymentLinksResponse,
                rawResponse: _response.rawResponse,
            };
        }
     ...
     *
     * @param {Payroc.payments.DeactivatePaymentLinksRequest} request
     * @param {PaymentLinksClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Payroc.BadRequestError}
     * @throws {@link Payroc.UnauthorizedError}
    ...
    public deactivate(
        ...
        requestOptions?: PaymentLinksClient.RequestOptions,
    ): core.HttpResponsePromise<Payroc.payments.DeactivatePaymentLinksResponse> {
    ...
    private async __deactivate(
        request: Payroc.payments.DeactivatePaymentLinksRequest,
        requestOptions?: PaymentLinksClient.RequestOptions,
    ): Promise<core.WithRawResponse<Payroc.payments.DeactivatePaymentLinksResponse>> {
        const { paymentLinkId } = request;
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            _authRequest.headers,
        ...
        if (_response.ok) {
            return {
                data: _response.body as Payroc.payments.DeactivatePaymentLinksResponse,
                rawResponse: _response.rawResponse,
            };
        }
