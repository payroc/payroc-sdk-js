...
export class SharingEventsClient {
     ...
     *
     * @param {Payroc.paymentLinks.ListSharingEventsRequest} request
     ...
     *
     * @example
     *     await client.paymentLinks.sharingEvents.list({
    ...
    public async list(
        ...
        const _sendRequest = async (request: core.Fetcher.Args) => {
            const _response = await core.fetcher<Payroc.SharingEventPaginatedList>(request);
            if (_response.ok) {
                return _response;
            }
        ...
        return core.createPayrocPager<Payroc.PaymentLinkEmailShareEvent, Payroc.SharingEventPaginatedList>({
     ...
     *
     * @param {Payroc.paymentLinks.ShareSharingEventsRequest} request
     * @param {SharingEventsClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Payroc.BadRequestError}
     * @throws {@link Payroc.UnauthorizedError}
